...
<p align="center">
<b>Kariana:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
👉 Masaüstü için Kariana (Mac, Windows ve Linux)! <a href="https://kariana.com/download" target="_blank"> Şimdi İndir</a>
</p>
...
![Mesajlaşma](https://github.com/INGIPSA/kariana/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/INGIPSA/kariana-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- **`embed`**: [Web gömme widget’ı](https://github.com/INGIPSA/kariana-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/INGIPSA/kariana-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

INGIPSA ve topluluk, Kariana'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Kariana kurun →](../BARE_METAL.md)
...
_Bu uygulamalar INGIPSA tarafından yönetilmemektedir, ancak Kariana ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/kariana/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.
- [Coolify](https://coolify.io/docs/services/kariana/) - Tek tıklamayla Kariana dağıtımı yapmanıza olanak tanır.
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - Kariana’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik

INGIPSA Inc. tarafından geliştirilen Kariana, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>
<summary><kbd>Kariana için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, Kariana’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AINGIPSA%2Fkariana%20.sendTelemetry(&type=code)
...
Telif Hakkı © 2026 [INGIPSA][profile-link]. <br />
