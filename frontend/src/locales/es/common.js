...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Kariana puede funcionar con muchos proveedores de LLM. Este será el servicio que gestionará el chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bienvenido a Kariana",
      description:
        "Ayúdanos a hacer que Kariana se adapte a tus necesidades. Opcional.",
      email: "¿Cuál es tu correo electrónico?",
      useCase: "¿Para qué usarás Kariana?",
      useCaseWork: "Para el trabajo",
      useCasePersonal: "Para uso personal",
      useCaseOther: "Otro",
      comment: "¿Cómo te enteraste de Kariana?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Explícame",
      body: "los beneficios de Kariana",
    },
    delete: {
  ...
  customization: {
    interface: {
      ...
      description:
        "Establece tus preferencias de la interfaz de usuario para Kariana.",
    },
    branding: {
      title: "Marca y marca blanca",
      description:
        "Personaliza tu instancia de Kariana con tu propia marca.",
    },
    chat: {
      title: "Chat",
      description: "Establece tus preferencias de chat para Kariana.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona el idioma preferido para renderizar la interfaz de usuario de Kariana, cuando las traducciones estén disponibles.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        user: "usuario",
        message: "mensaje",
        assistant: "Asistente de chat de Kariana",
  ...
  api: {
    title: "Claves de API",
    description:
      "Las claves de API permiten al titular acceder y administrar programáticamente esta instancia de Kariana.",
  ...
  llm: {
    title: "Preferencia de LLM",
    description:
      "Estas son las credenciales y la configuración de tu proveedor preferido de chat e incrustación de LLM. Es importante que estas claves estén actualizadas y sean correctas, de lo contrario, Kariana no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local de Whisper en máquinas con RAM o CPU limitadas puede detener Kariana al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que Kariana pueda usar para procesar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y la configuración de cómo funcionará tu instancia de Kariana. Es importante que estas claves estén actualizadas y sean correctas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración sobre cómo los proveedores de terceros conectados y Kariana manejan tus datos.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Estos archivos se subirán al procesador de documentos que se ejecuta en esta instancia de Kariana. Estos archivos no se envían ni se comparten con terceros.",
    },
    pinning: {
      what_pinning: "¿Qué es fijar documentos?",
      pin_explained_block1:
        "Cuando <b>fijas</b> un documento en Kariana, inyectaremos todo el contenido del documento en tu ventana de prompt para que tu LLM lo comprenda por completo.",
      ...
      pin_explained_block3:
        "Si no obtienes las respuestas que deseas de Kariana por defecto, fijar es una excelente manera de obtener respuestas de mayor calidad con un clic.",
      accept: "Ok, entendido",
    },
    watching: {
      what_watching: "¿Qué hace observar un documento?",
      watch_explained_block1:
        "Cuando <b>observas</b> un documento en Kariana, sincronizaremos <i>automáticamente</i> el contenido de tu documento desde su fuente original a intervalos regulares. Esto actualizará automáticamente el contenido en cada espacio de trabajo donde se gestione este archivo.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Necesitas autenticarte con el Centro de la Comunidad de Kariana antes de publicar elementos.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de Kariana con una contraseña. Si la olvidas, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
