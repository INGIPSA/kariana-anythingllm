...
import Kariana from "./media/logo/kariana-logo.svg";
import KarianaDark from "./media/logo/kariana-logo-light.svg";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(KarianaDark) : setLogo(Kariana);
