...
const SHOW_METRICS_KEY = "kariana_show_chat_metrics";
const SHOW_METRICS_EVENT = "kariana_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `kariana_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `kariana_show_chat_metrics` key
 * @returns {void}
 */
