...
https://github.com/INGIPSA/kariana-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/kariana-chat-widget.min.js">
</script>
<!-- Kariana (https://kariana.app) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/INGIPSA/kariana-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
