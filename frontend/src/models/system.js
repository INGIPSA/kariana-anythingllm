...
const System = {
  cacheKeys: {
    footerIcons: "kariana_footer_links",
    supportEmail: "kariana_support_email",
    customAppName: "kariana_custom_app_name",
    canViewChatHistory: "kariana_can_view_chat_history",
    deploymentVersion: "kariana_deployment_version",
  },
  ping: async function () {
