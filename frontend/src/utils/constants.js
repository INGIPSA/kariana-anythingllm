...
export const ONBOARDING_SURVEY_URL = "https://onboarding.kariana.app";

export const AUTH_USER = "kariana_user";
export const AUTH_TOKEN = "kariana_authToken";
export const AUTH_TIMESTAMP = "kariana_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "kariana_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "kariana_pinned_document_alert";
export const SEEN_WATCH_ALERT = "kariana_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "kariana_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "kariana_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "kariana_pending_home_message";

export const APPEARANCE_SETTINGS = "kariana_appearance_settings";
