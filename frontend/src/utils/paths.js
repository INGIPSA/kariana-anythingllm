...
export default {
  ...
  github: () => {
    return "https://github.com/INGIPSA/kariana";
  },
  discord: () => {
    return "https://discord.com/invite/6UyHPeGZAC";
  },
  docs: () => {
    return "https://docs.kariana.app";
  },
  chatModes: () => {
    return "https://docs.kariana.app/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@kariana.app";
  },
  hosting: () => {
    return "https://my.kariana.app/aio-checkout?product=kariana";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.kariana.app/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.kariana.app links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.kariana.app/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.kariana.app/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
