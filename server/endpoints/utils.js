 ...
 * as well as build features in Kariana directly for a specific model or capabilities.
 *
 * Disable with  {@link https://github.com/INGIPSA/kariana?tab=readme-ov-file#telemetry--privacy|Disable Telemetry}
...
/**
 * Returns the user agent for the Kariana deployment.
 * @returns {string} The user agent.
 */
function getKarianaUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `Kariana/${version}`;
}
