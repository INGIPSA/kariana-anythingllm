...
5. Use the file `cloudformation_create_kariana.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_kariana  Created 
 ⠿ Container kariana       Started  
```
